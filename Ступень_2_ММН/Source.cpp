...
int main(int argc, char* argv[]) {
    ...
    // --- 2. Общие переменные для вывода ---
    int total_n = 0;
    double total_e = 0.0, r_n = 0.0;
    double E_error = 0.0, x_max = 0.0, y_max = 0.0;
    double r_0_initial = 0.0;

    // Переменные для второй сетки
    int total_n_2 = 0;
    ...
    if (task_type == 0) {
        ...
        r_n = solver1.final_eps; // В ММН финальная ошибка = норма невязки
